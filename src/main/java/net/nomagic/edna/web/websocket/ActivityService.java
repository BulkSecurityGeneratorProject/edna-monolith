package net.nomagic.edna.web.websocket;

import net.nomagic.edna.security.SecurityUtils;
import net.nomagic.edna.web.websocket.dto.ActivityDTO;
...
import static net.nomagic.edna.config.WebsocketConfiguration.IP_ADDRESS;
