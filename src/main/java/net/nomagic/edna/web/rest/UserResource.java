package net.nomagic.edna.web.rest;

import net.nomagic.edna.config.Constants;
import com.codahale.metrics.annotation.Timed;
import net.nomagic.edna.domain.Authority;
import net.nomagic.edna.domain.User;
import net.nomagic.edna.repository.AuthorityRepository;
import net.nomagic.edna.repository.UserRepository;
import net.nomagic.edna.security.AuthoritiesConstants;
import net.nomagic.edna.service.MailService;
import net.nomagic.edna.service.UserService;
import net.nomagic.edna.web.rest.dto.ManagedUserDTO;
import net.nomagic.edna.web.rest.util.HeaderUtil;
import net.nomagic.edna.web.rest.util.PaginationUtil;
